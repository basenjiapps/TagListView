...
open class TagListView: UIView {
    ...
    @IBInspectable open dynamic var tCornerRadius: CGFloat = 0 {
        didSet {
            tagViews.forEach {
                $0.cornerRadius = tCornerRadius
            }
        }
    }
    ...
    private func rearrangeViews() {
        ...
        for (index, tagView) in tagViews.enumerated() {
            ...
            tagBackgroundView.layer.shadowPath = UIBezierPath(roundedRect: tagBackgroundView.bounds, cornerRadius: tCornerRadius).cgPath
    ...
    private func createNewTagView(_ title: String) -> TagView {
        ...
        tagView.cornerRadius = tCornerRadius
